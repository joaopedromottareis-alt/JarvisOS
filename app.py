...
# CSS Global Avançado - Forçando a remoção de TODAS as caixas, bordas e fundos nativos do Streamlit
st.markdown("""
    <style>
    ...
    /* 3. REMOÇÃO AGRESSIVA E COMPLETA DE CAIXAS, BORDAS E CONTÊINERES DO STREAMLIT */
    ...
    /* Inputs fluidos e minimalistas - Mantendo apenas a caixinha do input em si */
    ...
    /* Estilo do Calendário Envolvido */
    .calendar-container {
